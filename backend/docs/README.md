...
本目录存放 `rfpt` 后端开发规范和模块说明。编码助手处理后端任务时，先读取仓库根目录 `AGENTS.md`，再读取 `backend/docs/backend-rules/ASSISTANT.md`。
...
```text
backend/docs/services/rfpt-performance/employee-performance.md
```
