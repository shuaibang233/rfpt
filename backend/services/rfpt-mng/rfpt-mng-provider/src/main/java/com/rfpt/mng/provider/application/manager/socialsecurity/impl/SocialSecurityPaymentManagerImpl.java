package com.rfpt.mng.provider.application.manager.socialsecurity.impl;
...
import com.rfpt.mng.provider.application.command.socialsecurity.SocialSecurityPaymentBatchCreateCommand;
import com.rfpt.mng.provider.application.command.socialsecurity.SocialSecurityPaymentTaskRetryCommand;
import com.rfpt.mng.provider.application.manager.socialsecurity.SocialSecurityPaymentManager;
import com.rfpt.mng.provider.application.port.gateway.robot.tax.TaxRobotGateway;
import com.rfpt.mng.provider.application.port.persistence.socialsecurity.SocialSecurityPaymentBatchPersistencePort;
import com.rfpt.mng.provider.application.port.persistence.socialsecurity.SocialSecurityPaymentTaskPersistencePort;
import com.rfpt.mng.provider.application.port.persistence.socialsecurity.data.SocialSecurityPaymentBatchData;
import com.rfpt.mng.provider.application.port.persistence.socialsecurity.data.SocialSecurityPaymentTaskData;
import com.rfpt.mng.provider.application.port.persistence.socialsecurity.record.SocialSecurityPaymentBatchRecord;
import com.rfpt.mng.provider.application.port.persistence.socialsecurity.record.SocialSecurityPaymentTaskRecord;
import com.rfpt.mng.provider.application.query.socialsecurity.SocialSecurityPaymentBatchQuery;
import com.rfpt.mng.provider.application.query.socialsecurity.SocialSecurityPaymentTaskQuery;
import com.rfpt.mng.provider.application.result.socialsecurity.SocialSecurityPaymentBatchResult;
import com.rfpt.mng.provider.application.result.socialsecurity.SocialSecurityPaymentTaskResult;
import com.rfpt.mng.provider.domain.socialsecurity.SocialSecurityPaymentBatchStatus;
import com.rfpt.mng.provider.domain.socialsecurity.SocialSecurityPaymentTaskStatus;
