 ...
 * 员工端绩效持久化端口。
 */
public interface EmployeePerformanceClientPersistencePort {
     ...
     * @return 员工绩效记录
     */
    List<EmployeePerformanceClientRecord> listPendingFirstConfirmRecordsByTaskIds(List<Long> taskIds, int limit);
     ...
     * @return 员工绩效记录
     */
    List<EmployeePerformanceClientRecord> listPendingSecondConfirmRecordsByTaskIds(List<Long> taskIds, int limit);
     ...
     * @return 员工绩效记录
     */
    EmployeePerformanceClientRecord getByIdAndMobile(Long id, String mobile);
