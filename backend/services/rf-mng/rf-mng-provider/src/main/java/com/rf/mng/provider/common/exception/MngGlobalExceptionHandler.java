package com.rf.mng.provider.common.exception;
...
public class MngGlobalExceptionHandler {
    ...
    public Result<Void> handleBusinessException(BusinessException exception) {
        log.warn("管理后台业务异常，code={}, message={}", exception.getErrorCode().getCode(), exception.getMessage());
    ...
    public Result<Void> handleHttpMessageNotReadableException(HttpMessageNotReadableException exception) {
        log.warn("管理后台请求体读取异常", exception);
    ...
    public Result<Void> handleBindException(BindException exception) {
        ...
        log.warn("管理后台参数绑定异常，message={}", message);
    ...
    public Result<Void> handleMethodArgumentNotValidException(MethodArgumentNotValidException exception) {
        ...
        log.warn("管理后台参数校验异常，message={}", message);
        return Result.error(ErrorCode.E999001, message);
    }
